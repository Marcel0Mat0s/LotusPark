...
namespace LotusPark.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,NIF,Telefone,Email,CodPostal,Morada,Cargo,DataNascimento")] Funcionarios funcionarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,NIF,Telefone,Email,CodPostal,Morada,Cargo,DataNascimento")] Funcionarios funcionarios)
        {
